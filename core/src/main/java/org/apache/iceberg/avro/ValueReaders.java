...
public class ValueReaders {
  ...
  /** Reads Avro dates as zoneless timestamps, failing if a value exceeds the target range. */
  public static ValueReader<Long> datesAsTimestamps(Type.PrimitiveType target) {
