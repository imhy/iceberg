...
class TestDateToTimestampSql {
  ...
  @ParameterizedTest
  @MethodSource("modes")
  void preservesDistinctInitialAndWriteDefaults(String format, boolean vectorized, String zone)
      throws Exception {
    spark.conf().set("spark.sql.session.timeZone", zone);
    ...
    sql("REFRESH TABLE %s");
    sql("INSERT INTO %s (id) VALUES (2)");
    sql("INSERT INTO %s (id, d) VALUES (3, NULL)");
    sql("INSERT INTO %s (id, d) VALUES (4, DATE '2020-01-02')");
